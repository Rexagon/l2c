...
$(document).ready(function() {
    ...
    var dialogs = [{
        ...
        description: 'Любая современная компания в наше время имеет свой собственный сайт. На сайте размещается вся важная информация о Вашей компании и об услугах/товарах,которые Вы представляете. ', 
